--[[ Script contendo o module #anvilwar, #mestre, #true_false, #objects e #pistas. Compilado às 13h37 (UTC) 29/02/2020. ]]--
...
function eventLoop(p,f)
	...
	ui.setMapName("<J>"..text.module.."   <G>|   <N>Question : <V>"..pergunta.."/"..limite.."   <G>|   <N>Time : <V>"..tempo.."s   <G>|   <N>Compilation RTM 23<")
end
function eventChatCommand(name,message)
	if message == "skip" then
...
tfm.exec.chatMessage("#anvilwar Universal Mode Loader version 1.95<br>by Spectra_phantom#6089<br><br>The requested room is loading or updating. Please wait...",nil)
