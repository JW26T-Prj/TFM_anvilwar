-- Transformice #anvilwar module loader - Version 2.270.2
...
-- Version : RTM 56670.273 LTS
-- Compilation date : 08/09/2024 01:39 UTC
...
function showLobbyText(name)
	ui.addTextArea(402,"<p align='center'><font size='12'><b><font face='Courier New'><i>"..text.version.." RTM 56670.273 LTS - "..text.comp_date.."08/09/2024 01:39 UTC - "..text.uploaded.."Spectra_phantom#6089</i>",name,-10,380,820,36,0,0,1.0,true)
end
...
function updateTextBar()
	if mode == "end" then
		...
		ui.setMapName("<N><b>#anvilwar</b>   <G>|   <VP>"..text.version.." <b>RTM 56670.273 LTS</b> <R>   <G>|   <N>"..text.mices_room.."<V><b>"..mices.."</b><")
	end
end
...
function eventChatCommand(name,command)
	...
	if command == "changelog" then
		showMenu(name,0xa8f233,140,130,520,110,"#anvilwar Changelog - RTM 56670.273 LTS","• The bot monitoring system is disabled temporarily<br>• Various minor bugfixes<br>• Added 1 new map")
	end
...
tfm.exec.chatMessage("<ROSE><b>#anvilwar</b> Multiple Module Loader revision 2<br>Version 2.270.2<br>By Spectra_phantom#6089")
