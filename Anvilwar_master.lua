-- Transformice #anvilwar module loader - Version 2.265
...
-- Version : RTM 56361.264
-- Compilation date : 06/29/2024 17:14 UTC
...
function showLobbyText(name)
	ui.addTextArea(402,"<p align='center'><font size='12'><b><font face='Courier New'><i>"..text.version.." RTM 56361.264 - "..text.comp_date.."06/29/2024 17:14 UTC - "..text.uploaded.."Spectra_phantom#6089</i>",name,-10,380,820,36,0,0,1.0,true)
end
...
ninjas={"Viego#0345","G484#5825","Dharak#7603","Qiyana#2797","Skyymellu#0000","Akwimos#1937","Hwei#1027","Rakan#3159"}
...
function updateTextBar()
	if mode == "end" then
		...
		ui.setMapName("<N><b>#anvilwar</b>   <G>|   <VP>"..text.version.." <b>RTM 56361.264</b> <R>   <G>|   <N>"..text.mices_room.."<V><b>"..mices.."</b><")
	end
end
...
function eventChatCommand(name,command)
	...
	if command == "changelog" then
		showMenu(name,0xa8f233,140,130,520,125,"#anvilwar Changelog - RTM 56361.264","• Small bugfixes<br>• Added 2 new maps<br>• Some changes on the respawn offset<br>• Changes on player latency check")
	end
...
tfm.exec.chatMessage("<ROSE><b>#anvilwar</b> Multiple Module Loader revision 2<br>Version 2.265<br>By Spectra_phantom#6089")
