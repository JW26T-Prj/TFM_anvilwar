-- Transformice #anvilwar module loader - Version 2.267
...
-- Version : RTM 56565.268
-- Compilation date : 07/12/2024 14:22 UTC
...
function showLobbyText(name)
	ui.addTextArea(402,"<p align='center'><font size='12'><b><font face='Courier New'><i>"..text.version.." RTM 56565.268 - "..text.comp_date.."07/12/2024 14:22 UTC - "..text.uploaded.."Spectra_phantom#6089</i>",name,-10,380,820,36,0,0,1.0,true)
end
...
function updateTextBar()
	if mode == "end" then
		...
		ui.setMapName("<N><b>#anvilwar</b>   <G>|   <VP>"..text.version.." <b>RTM 56565.268</b> <R>   <G>|   <N>"..text.mices_room.."<V><b>"..mices.."</b><")
	end
end
...
ss={"Viego#0345","Dharak#7603","Qiyana#2797","Skyymellu#0000","Akwimos#1937","Hwei#1027"}
...
function giveRankings(name)
	if data[name] then
		...
		elseif tableSearch(ss,name) == true then
			data[name].ranking=3
...
function eventChatCommand(name,command)
	...
	if command == "changelog" then
		showMenu(name,0xa8f233,140,130,520,105,"#anvilwar Changelog - RTM 56565.268","• Added 3 new maps<br>• Some bugfixes<br>• More changes in anvil spawns")
	end
...
lang.br = {
	welcome = "<font color='#0080ff'><b>Bem-vindos ao module Rakan's Watercatch!</b><br><VP>Fuja do shaman (tubarão) e sobreviva no perigoso mar!<br><J>Digite !help para ver a ajuda deste module.<br><br><N>Module ",
	changelog = "• Mudanças de nomenclatura",
...
lang.en = {
	welcome = "<font color='#0080ff'><b>Welcome to the Rakan's Watercatch module!</b><br><VP>Run away from the shark (shaman) and survive in the dangerous sea!<br><J>Type !help to see the game help.<br><br><N>Module ",
	changelog = "• Naming changes",
...
function eventChatCommand(name,message)
	...
	if message == "changelog" then
		showMenu(name,0xf0f0f0,140,130,520,100,"Rakan's Watercatch Changelog - v6.2",text.changelog)
	end
...
function eventNewGame()
	...
	if changed == true then
		...
		for n,p in next,tfm.get.room.playerList do
			...
			ui.setMapName("<font color='#0080ff'><b>Rakan's Watercatch!</b><N> <VP><b>v6.2</b><N> - "..text.madeby.." <R><b>Rakan#3159</b><")
			if n:sub(1,1) == "*" then
...
tfm.exec.chatMessage("<ROSE><b>#anvilwar</b> Multiple Module Loader revision 2<br>Version 2.267<br>By Spectra_phantom#6089")
