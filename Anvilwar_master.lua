-- Transformice #anvilwar module loader - Version 2.196
...
Version : RTM 43182.155
Compilation date : 10/14/2021 21:08 UTC
...
for _,g in next,{"reset","help","sync","pw","commands","powerups","p","kill","limit","ranking","tc","anvils","print","set","testmap","defmap","leader","rv","tp","changelog","tm","change","compmode","change_switch"} do
...
function showLobbyText(name)
	ui.addTextArea(403,"<p align='center'><font color='#000000'><font size='13'><i>"..text.comp_date.."10/14/2021 21:08 UTC - "..text.uploaded.."Velkozdapic#0000</i>",name,92,44,600,60,0,0,1.0,true)
	ui.addTextArea(402,"<p align='center'><font size='13'><i>"..text.comp_date.."10/14/2021 21:08 UTC - "..text.uploaded.."Velkozdapic#0000</i>",name,90,42,600,60,0,0,1.0,true)
end
...
function updateTextBar()
	if mode == "lobby" or mode == "map_sort" or mode == "wait1" then
		ui.setMapName("<N><b>#anvilwar Reborn</b>   <G>|   <VP>"..text.version.." <b>RTM 43182.155</b> <R>   <G>|   <N>"..text.mices_room.."<V><b>"..mices.."</b><")
...
function eventChatCommand(name,command)
	...
	if command == "changelog" then
		showMenu(name,0xa8f233,140,90,520,132,"#anvilwar Changelog - RTM 43182.155","• Added 1 new map<br>• Minor bugfixes<br>• Reduced the team margins to 1 player<br>• The !ban command was removed")
	end
...
tfm.exec.chatMessage("<VP><b>#anvilwar</b> Multiple Module Loader revision 2<br>Version 2.196<br>By Spectra_phantom#6089")
if string.find(tfm.get.room.name,"*") then
