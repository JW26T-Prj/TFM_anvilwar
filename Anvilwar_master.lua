-- Transformice #anvilwar module loader - Version 2.147
-- By Spectra_phantom#6089 / Nasus_assassin#1534
-- Included sub-modules: #fall2, #objects, #watercatch.
...
play_vermelho={}
banned_list={}
mods_list={"Marichamex#0000","Ddniemo#0000","Gmctf#0000","Liviliviah#0000","Ork#0015","Sorreltail#7677","Diadem#9470","Pamots#0010"}
...
lang.br = {
	...
	bar = "<b>#anvilwar</b> RTM 28609.185",
...
function eventChatCommand(name,message)
	...
	if message == "powerups" then
		menuShow(name,text.powerupslist,"F1 (Double Anvil) - Cost: 5pt - Required Level: 1 - Function: <a href='event:power1'>Show</a><br>F2 (Triple Anvil) - Cost: 15pt - Required Level: 2 - Function: <a href='event:power2'>Show</a><br>F3 (Random Shoot) - Cost: 7pt - Required Level: 2 - Function: <a href='event:power3'>Show</a><br>F4 (Explosion) - Cost: 30pt - Required Level: 3 - Function: <a href='event:power4'>Show</a><br>F5 (Immortal Mode) - Cost: 30pt - Required Level: 5 - Function: <a href='event:power5'>Show</a><br>F6 (Decrease Size) - Cost: 15pt - Required Level: 4 - Function: <a href='event:power6'>Show</a><br>F7 (Anvil Sequence) - Cost: 30pt - Required Level: 4 - Function: <a href='event:power7'>Show</a>",115)
	end
end
...
tfm.exec.newGame("@7803705")
	tfm.exec.chatMessage("<J>/room #anvilwar<br>/room #anvilwar00fall2<br>/room #anvilwar00objects<br>/room #anvilwar00watercatch<br>/room #anvilwar00fg")
function eventNewPlayer(name)
	tfm.exec.chatMessage("<J>/room #anvilwar<br>/room #anvilwar00fall2<br>/room #anvilwar00objects<br>/room #anvilwar00watercatch<br>/room #anvilwar00fg")
end
end

tfm.exec.chatMessage("<VP><b>#anvilwar</b> Multiple Module Loader revision 2<br>Version 2.147<br>By Spectra_phantom#6089 and Nasus_assassin#1534")
if string.find(tfm.get.room.name,"*") then
	...
	elseif string.find(tfm.get.room.name,"fall2") then
		tfm.exec.chatMessage("<br><VP>Detected keyword 'fall2' on room name.<br>Initialising submodule #fall...")
		initFall()
	...
	elseif string.find(tfm.get.room.name,"watercatch") then
		...
		initWatercatch()
	elseif string.find(tfm.get.room.name,"fg") then
		tfm.exec.chatMessage("<br><VP>Detected keyword 'fg' on room name.<br>Initialising submodule #falling...")
		initFg()
