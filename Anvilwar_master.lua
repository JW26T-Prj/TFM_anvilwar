-- Transformice #anvilwar module loader - Version 2.173
...
function showLobbyText(name)
	ui.addTextArea(401,"<p align='center'><font color='#000000'><font size='18'><i>#anvilwar Reborn - "..text.version.." RTM 40838.129 </i>",name,52,18,700,60,0,0,1.0,true)
	ui.addTextArea(400,"<p align='center'><font size='18'><i>#anvilwar Reborn - "..text.version.." RTM 40838.129 <R></i>",name,50,16,700,60,0,0,1.0,true)
...
function updateTextBar()
	if mode == "lobby" or mode == "map_sort" or mode == "wait1" then
		ui.setMapName("<N><b>#anvilwar Reborn</b>   <G>|   <VP>"..text.version.." <b>RTM 40838.129</b> <R>   <G>|   <N>"..text.mices_room.."<V><b>"..mices.."</b><")
...
tfm.exec.chatMessage("<VP><b>#anvilwar</b> Multiple Module Loader revision 2<br>Version 2.173<br>By Spectra_phantom#6089")
if string.find(tfm.get.room.name,"*") then
	initAnvilwar()
else
