-- Transformice #anvilwar module loader - Version 2.233
...
tfm.exec.chatMessage("<R>O modo #watercatch foi desativado temporariamente para manutenção.")
end
...
tfm.exec.chatMessage("<ROSE><b>#anvilwar</b> Multiple Module Loader revision 2<br>Version 2.233<br>By Morganadxana#0000")
