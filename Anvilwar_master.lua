-- Transformice #anvilwar module loader - Version 2.234
...
Version : RTM 50317.200
Compilation date : 10/26/2022 20:45 UTC
...
function showLobbyText(name)
	ui.addTextArea(402,"<p align='center'><font size='13'><b><font face='Courier New'><i>"..text.version.." RTM 50317.200 - "..text.comp_date.."10/26/2022 20:45 UTC - "..text.uploaded.."Morganadxana#0000</i>",name,-10,380,820,36,0,0,1.0,true)
end
...
function updateTextBar()
	if mode == "end" then
		...
		ui.setMapName("<N><b>#anvilwar</b>   <G>|   <VP>"..text.version.." <b>RTM 50317.200</b> <R>   <G>|   <N>"..text.mices_room.."<V><b>"..mices.."</b><")
	end
end
...
function eventChatCommand(name,command)
	...
	if command == "changelog" then
		showMenu(name,0xa8f233,140,110,520,100,"#anvilwar Changelog - RTM 50317.200","• Some changes on text display")
	end
...
tfm.exec.chatMessage("<ROSE><b>#anvilwar</b> Multiple Module Loader revision 2<br>Version 2.234<br>By Morganadxana#0000")
