-- Transformice #anvilwar module loader - Version 2.189
...
tfm.exec.chatMessage("<VP><b>#anvilwar</b> Multiple Module Loader revision 2<br>Version 2.189<br>By Spectra_phantom#6089")
if string.find(tfm.get.room.name,"*") then
