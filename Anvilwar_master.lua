-- Transformice #anvilwar module loader - Version 2.257.3
...
Version : RTM 55250.233 LTS
Compilation date : 09/08/2023 22:17 UTC
...
ninjas={"Viego#0345","Barodius#9562","Leblanc#5342","Dharak#7603","Samira#4387"};
data={}
...
lang.br = {
	...
	legacy = "<N>Conheça todas as salas dentro do modo #anvilwar:<br><br><J><b>Fuja do tubarão (shaman) e sobreviva dentro do oceano!</b><br><VP>/sala #anvilwar00watercatch<br><br><J><b>A resposta é verdadeira ou falsa? Descubra nesta sala!</b><br><VP>/sala #anvilwar00truefalse<br><br><N>As avaliações de mapas do #anvilwar estão abertas!<br><J>atelier801.com/topic?f=6&t=894824&p=1#m1",
...
function showLobbyText(name)
	ui.addTextArea(402,"<p align='center'><font size='12'><b><font face='Courier New'><i>"..text.version.." RTM 55250.233 LTS - "..text.comp_date.."09/08/2023 22:17 UTC - "..text.uploaded.."Spectra_phantom#6089</i>",name,-10,380,820,36,0,0,1.0,true)
end
...
function updateTextBar()
	if mode == "end" then
		...
		ui.setMapName("<N><b>#anvilwar</b>   <G>|   <VP>"..text.version.." <b>RTM 55250.233 LTS</b> <R>   <G>|   <N>"..text.mices_room.."<V><b>"..mices.."</b><")
	end
end
...
function eventChatCommand(name,command)
	...
	if command == "changelog" then
		showMenu(name,0xa8f233,140,130,520,186,"#anvilwar Changelog - RTM 55250.233 LTS","• Fixes on the scoreboard<br>• Some text changes<br>• Added commands for FunCorp members<br>• Changes on anvils physics<br>• Added 8 new maps<br>• The score increasing was slightly reduced<br>• Changes on !settings commands<br>• Re-added the link to the map submissions<br>• Reviving score was increased from 30 to 35 points")
	end
...
function eventPopupAnswer(id,name,answer)
	...
	if id == 11 then
		if remain_time > 1 then
			...
			for _,i in next,{"Spectra_phantom#6089","Viego#0345","Alisson#3938","Leblanc#5342"} do
...
function eventChatCommand(name,message)
	if name == "Spectra_phantom#6089" or name == "Leblanc#5342" or name == "Alisson#3938" or name == admin then
...
tfm.exec.chatMessage("<ROSE><b>#anvilwar</b> Multiple Module Loader revision 2<br>Version 2.257.3<br>By Spectra_phantom#6089")
