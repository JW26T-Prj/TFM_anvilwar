-- Transformice #anvilwar module loader - Version 2.265.1
...
-- Version : RTM 56462.265 LTS
-- Compilation date : 07/01/2024 13:35 UTC
...
function showLobbyText(name)
	ui.addTextArea(402,"<p align='center'><font size='12'><b><font face='Courier New'><i>"..text.version.." RTM 56462.265 LTS - "..text.comp_date.."07/01/2024 13:35 UTC - "..text.uploaded.."Spectra_phantom#6089</i>",name,-10,380,820,36,0,0,1.0,true)
end
...
ninjas={"Viego#0345","Dharak#7603","Qiyana#2797","Skyymellu#0000","Akwimos#1937","Hwei#1027","Rakan#3159"}
...
function updateTextBar()
	if mode == "end" then
		...
		ui.setMapName("<N><b>#anvilwar</b>   <G>|   <VP>"..text.version.." <b>RTM 56462.265 LTS</b> <R>   <G>|   <N>"..text.mices_room.."<V><b>"..mices.."</b><")
	end
end
...
function eventChatCommand(name,command)
	...
	if command == "changelog" then
		showMenu(name,0xa8f233,140,130,520,110,"#anvilwar Changelog - RTM 56462.265 LTS","• Added 3 new maps<br>• More changes on the respawn offset")
	end
...
tfm.exec.chatMessage("<ROSE><b>#anvilwar</b> Multiple Module Loader revision 2<br>Version 2.265.1<br>By Spectra_phantom#6089")
